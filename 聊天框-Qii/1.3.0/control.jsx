    ...
    avatarElement(data, index) { 
        ...
        const startLongPress = (event) => {
            ...
            timer = setTimeout(() => {
                ...
                this.emit('onLongPressAvatar', index, data, clientX, clientY)
                longPressState = true
            }, 500)
        }
        const stopLongPress = () => {
            clearTimeout(timer)
            if (!longPressState) {
                this.emit('onClickAvatar', index, data)
            }
            longPressState = false
        }
        return (
    ...
    bubbleElement(data, index) { 
        ...
        const startLongPress = (event) => {
            ...
            timer = setTimeout(() => {
                ...
                this.emit('onLongPressBubble', index, data, clientX, clientY)
                longPressState = true
            }, 500)
        }
        const stopLongPress = () => {
        ...
        >
            ...
            { data.type === 'richText' && <div dangerouslySetInnerHTML={{ __html: data.msg }}></div> }
