                                        ...
                                        <div>
                                            ...
                                            >
                                                {item.类型 === "纯" ? (
                                                    ...
                                                    <div
                                                        dangerouslySetInnerHTML={{ __html: item.文本 }}
                                                    />
                                                ) : (
                                                    item.文本
                                                )}
...
/** lightBlue积木 **/ types.properties.unshift({
    key: "data",
    label: "数据",
...
/**  本轻蓝超级框架由XJ王大哥(QQ2357942846)制作 **/ if (lightBlue生成) {
    let ind = 0;
