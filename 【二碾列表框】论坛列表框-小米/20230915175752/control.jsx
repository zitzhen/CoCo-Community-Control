                            ...
                            {this.data.length || !this.skeleton ?
                                this.data?.map((item, index) => (
                                    <antd.List.Item class='item'>
                                        ...
                                        <div>
                                            <span
                                                onClick={this.trigger.bind(this, '文本', index)}
                                            >
                                        ...
                                        <div>
                                            {item.图片?.map((imgItem, imgIndex) => (
                                                <img
                                                    onClick={this.trigger.bind(this, '图片', index, imgIndex)}
                                        ...
                                        <div>
                                            <span
                                                onClick={this.trigger.bind(this, '时间', index)}
                                            >
                                                {item.时间}
                                            </span>
                                            <div>
