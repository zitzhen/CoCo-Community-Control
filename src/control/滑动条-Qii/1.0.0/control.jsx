...
let types = {
    ...
    properties: [
        ...
        { key: 'inputFg', label: '未滑过颜色', valueType: 'color', defaultValue: '#EDEDF0' },
        { key: 'inputBg', label: '已滑过颜色', valueType: 'color', defaultValue: '#3280FF' },
    ...
    render() { return (
        <div className={`Qii_${this.__widgetId}`}>
            ...
            <input 
                ...
                onMouseDown={() => this.emit('inputStart', this.inputValue)}
                onMouseUp={() => this.emit('inputEnd', this.inputValue)}
                onTouchStart={() => this.emit('inputStart', this.inputValue)}
                onTouchEnd={() => this.emit('inputEnd', this.inputValue)}
                />
            ...
            <style>
                {`
                    ...
                    .Qii_${this.__widgetId} input {
                        ...
                        background: -webkit-linear-gradient(${this.inputBg}, ${this.inputBg}) no-repeat ${this.inputFg}; 
