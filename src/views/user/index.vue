...
const githubjson =fetchgithub();
const username = getLastPath();
const userinformation = getuserinformation(username);
  ...
  data: {
    message: `
        ...
        <div class="profile-header">
            <img src="" alt="用户头像" class="avatar" id="avatar_img">
            <div class="user-info">
                <h1 id="user_name">${githubjson.name}</h1>
                <!--用户GitHub名称-->
                <p id="user_introduction">${githubjson.bio}</p>
                <!--用户GitHub介绍-->
                <div class="stats">

                    <!--
                    <div class="stat-item">
                        <div class="stat-number">正在加载</div>
                        <div class="stat-label">文章</div>
                    </div>
                    -->

                    <div class="stat-item">
                        <div class="stat-number" id="number_of_controls">正在加载</div>
