...
let types = {
    ...
    icon: "https://static.bcmcdn.com/coco/player/unstable/HJlB7E32kg.image/svg+xml?hash=Fus_awo7FP8kp24uQR8fGfb15Ngt",
    docs: { url: 'https://www.yuque.com/yuqueyonghuslrsu6/qcqduw/xsz3g8nodpvqmmvv' },
    version: "1.3.2",
    isInvisibleWidget: false,
    isGlobalWidget: false,
    properties: [
        { key: '__width', label: '宽度', valueType: 'number', defaultValue: 100 },
        ...
        { key: 'imageRadius', label: '主图圆角', valueType: 'number', defaultValue: 8, unit: '像素' },
        ...
        { key: 'rightIcon', label: '右侧箭头', valueType: 'boolean', defaultValue: true },
    ],
    events: [
        { key: 'onLoadMore', label: '滑动到底部', params: [] },
    ],
    methods: [
        {
...
class Widget extends VisibleWidget {
    ...
    // 添加滚动监听器
    addScrollListener() {
        document.getElementById(this.listId).addEventListener('scroll', (event) => {
            let scrollTop = event.target.scrollTop
            let clientHeight = event.target.clientHeight
            let scrollHeight = event.target.scrollHeight
            if (!this.loading && scrollTop + clientHeight >= scrollHeight - 10) {
                this.loading = true
        ...
        <style>
            {`
                ...
                #${this.listId} .style_bannerImgBox__nIUOv .style_imageWidget__y1BJc {
                    ...
                    border-radius: ${this.imageRadius}px !important;
                }
                ...
                #${this.listId} .style_title__TlUlN .style_content__1QoMj {
                ...
                /* 右侧箭头 */
                #${this.listId} .style_iconBox__2iYJD {
                    display: ${this.rightIcon ? 'block' : 'none'};
                }
            `}
        </style>
    )}
